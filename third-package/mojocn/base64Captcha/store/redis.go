...
// redisStore is use redis_lock to store for captcha ids and their values.
...
// NewRedisStore newRedisStoreByDetail returns a new redis_lock store for captcha with the
